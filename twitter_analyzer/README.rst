===============================================
get_Sentiment based on VADER-Sentiment-Analysis
===============================================

This is a tuned VADER-Sentiment-Analysis for tweeter analysis. The example code on analyzing any desierd tweet data can be found in get_sentiment_data.
...
You don't need install it to use VADER sentiment:  

#. The simplest is to use the command line to do an installation:
